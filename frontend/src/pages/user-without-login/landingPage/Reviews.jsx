...
const TestimonialData = [
  ...
  },
  {
    ...
    coffee: "Ethiopian Brew"
  },
  {
    id: 3,
    name: "Zishan",
    text: "I always stop by for their iced caramel macchiato. It's the perfect pick-me-up during a long day.",
    img: "https://images.unsplash.com/photo-1552058544-f2b08422138a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80",
    coffee: "Soul Brew"
  },
];
...
const Reviews = () => {
  ...
  return (
    <div id="reviews" className="py-20 bg-gradient-to-b from-[#3e2723] to-[#5d4037] relative overflow-hidden">
      {/* Decorative elements */}
                ...
                >
                  ...
                  <div className="flex justify-center mt-4">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg 
                        key={star} 
                        className="w-4 h-4 text-amber-500 fill-current group-hover:text-amber-400 transition-colors duration-500" 
                        viewBox="0 0 24 24"
                      >
