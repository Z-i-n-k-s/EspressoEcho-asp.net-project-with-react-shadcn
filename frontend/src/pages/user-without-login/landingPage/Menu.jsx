...
const MenuData = [
  {
    ...
    name: "Espresso",
    description:
      "A rich and bold shot of pure coffee bliss, perfect to kickstart your day.",
    price: 150,
  },
  {
    id: 2,
    ...
    name: "Cappuccino",
    description:
      "Creamy, frothy, and perfectly brewed with steamed milk and espresso.",
    price: 220,
  },
  {
    id: 1,
    ...
    description:
      "Smooth and creamy cheesecake with a buttery graham cracker crust.",
    price: 250,
  },
];
...
const Menu = () => {
  ...
  return (
    <div id="menu" className="py-20 bg-[#4e342e]">
      {" "}
