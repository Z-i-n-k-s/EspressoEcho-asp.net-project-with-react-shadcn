    ...
    return (
        <div id='contact' style={bgImage} className='min-h-screen flex items-center justify-center p-6'>
            <motion.div
                ...
                <h1
                    className='text-3xl font-bold text-center text-[#4e342e] mb-6 font-cursive'>--Contact Us--</h1>
                <p className='text-center text-lg text-black mb-8 font-cursive'>We would love to hear from you! Fill out the form below and we’ll get back to you as soon as possible.</p>
